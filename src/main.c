/*
 * main.c — scoobiii-rinha-2026
 * POST /fraud-score + GET /ready via Unix socket
 * Thread pool + IVF KNN-5
 */
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
...
#ifndef SOCKET_PATH
#define SOCKET_PATH "/sockets/api.sock"
#endif
...
static void handle_fraud(int fd, const char *body) {
    ...
    float vec[DIMS];
    build_vector(vec, (float)amount, installs, req_at,
